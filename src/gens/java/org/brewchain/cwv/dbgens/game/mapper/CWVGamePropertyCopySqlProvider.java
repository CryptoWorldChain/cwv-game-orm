...
import org.brewchain.cwv.dbgens.game.entity.CWVGamePropertyCopyExample.Criterion;
import org.brewchain.cwv.dbgens.game.entity.CWVGamePropertyCopyExample;

public class CWVGamePropertyCopySqlProvider {
     ...
     */
    public String countByExample(CWVGamePropertyCopyExample example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Wed Jul 25 18:19:00 CST 2018
     */
    public String deleteByExample(CWVGamePropertyCopyExample example) {
        BEGIN();
        DELETE_FROM("cwv_game_property_copy");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Wed Jul 25 18:19:00 CST 2018
     */
    public String insertSelective(CWVGamePropertyCopy record) {
        BEGIN();
        INSERT_INTO("cwv_game_property_copy");
     ...
     * @mbggenerated Wed Jul 25 18:19:00 CST 2018
     */
    public String selectByExample(CWVGamePropertyCopyExample example) {
        BEGIN();
		...
		if (example != null && example.isDistinct()) {
			SELECT_DISTINCT(example.getSelectCols());
				...
				FROM("cwv_game_property_copy");				applyWhere(example, false);
		}
        if(example != null){
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CWVGamePropertyCopy record = (CWVGamePropertyCopy) parameter.get("record");
        CWVGamePropertyCopyExample example = (CWVGamePropertyCopyExample) parameter.get("example");
     ...
     * @mbggenerated Wed Jul 25 18:19:00 CST 2018
     */
    public String updateByPrimaryKeySelective(CWVGamePropertyCopy record) {
        BEGIN();
        UPDATE("cwv_game_property_copy");
     ...
     * @mbggenerated Wed Jul 25 18:19:00 CST 2018
     */
    protected void applyWhere(CWVGamePropertyCopyExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
