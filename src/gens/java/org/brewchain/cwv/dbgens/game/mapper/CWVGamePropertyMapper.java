...
public interface CWVGamePropertyMapper extends StaticTableDaoSupport<CWVGameProperty, CWVGamePropertyExample, CWVGamePropertyKey> {
    ...
    @Insert({
        ...
        "property_template_id, property_name, ",
        "property_type, property_status, ",
        "last_price, last_price_time, ",
        "image_url, is_display, ",
        "created_time, property_template)",
        "values (#{propertyId,jdbcType=INTEGER}, #{gameMapId,jdbcType=INTEGER}, ",
        "#{propertyTemplateId,jdbcType=INTEGER}, #{propertyName,jdbcType=VARCHAR}, ",
        "#{propertyType,jdbcType=VARCHAR}, #{propertyStatus,jdbcType=VARCHAR}, ",
        "#{lastPrice,jdbcType=DECIMAL}, #{lastPriceTime,jdbcType=TIMESTAMP}, ",
        "#{imageUrl,jdbcType=VARCHAR}, #{isDisplay,jdbcType=VARCHAR}, ",
        "#{createdTime,jdbcType=TIMESTAMP}, #{propertyTemplate,jdbcType=VARCHAR})"
    })
    ...
    @Results({
        ...
        @Result(column="property_template_id", property="propertyTemplateId", jdbcType=JdbcType.INTEGER),
    ...
    @Select({
        "select",
        "property_id, game_map_id, property_template_id, property_name, property_type, ",
        "property_status, last_price, last_price_time, image_url, is_display, created_time, ",
        "property_template",
    ...
    @Update({
        ...
        "set game_map_id = #{gameMapId,jdbcType=INTEGER},",
          "property_template_id = #{propertyTemplateId,jdbcType=INTEGER},",
