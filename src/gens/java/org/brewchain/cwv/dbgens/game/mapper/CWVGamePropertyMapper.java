...
public interface CWVGamePropertyMapper extends StaticTableDaoSupport<CWVGameProperty, CWVGamePropertyExample, CWVGamePropertyKey> {
    ...
    @Insert({
        ...
        "property_template_id, owner, ",
        "property_name, property_type, ",
        "property_status, income, ",
        ...
        "#{propertyTemplateId,jdbcType=INTEGER}, #{owner,jdbcType=INTEGER}, ",
        "#{propertyName,jdbcType=VARCHAR}, #{propertyType,jdbcType=VARCHAR}, ",
        "#{propertyStatus,jdbcType=VARCHAR}, #{income,jdbcType=DECIMAL}, ",
    ...
    @Select({
        "select",
        "property_id, game_map_id, property_template_id, owner, property_name, property_type, ",
        "property_status, income, last_price, last_price_time, image_url, is_display, ",
        "created_time, property_template",
