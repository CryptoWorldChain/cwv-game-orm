...
public interface CWVGamePropertyMapper extends StaticTableDaoSupport<CWVGameProperty, CWVGamePropertyExample, CWVGamePropertyKey> {
    ...
    @Insert({
        ...
        "#{owner,jdbcType=INTEGER}, #{propertyName,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "property_id, game_map_id, owner, property_name, property_type, property_status, ",
        "last_price, last_price_time, image_url, income, is_display, created_time, property_template_id, ",
        "property_template",
