...
import org.brewchain.cwv.dbgens.game.entity.CWVGameCountryExample.Criterion;
import org.brewchain.cwv.dbgens.game.entity.CWVGameCountryExample;

public class CWVGameCountrySqlProvider {
     ...
     */
    public String countByExample(CWVGameCountryExample example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Sat Jul 14 19:26:37 CST 2018
     */
    public String deleteByExample(CWVGameCountryExample example) {
        BEGIN();
        DELETE_FROM("cwv_game_country");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Sat Jul 14 19:26:37 CST 2018
     */
    public String insertSelective(CWVGameCountry record) {
        BEGIN();
        INSERT_INTO("cwv_game_country");
        ...
        if (record.getCountryNameZh() != null) {
            VALUES("country_name_zh", "#{countryNameZh,jdbcType=VARCHAR}");
        }
     ...
     * @mbggenerated Sat Jul 14 19:26:37 CST 2018
     */
    public String selectByExample(CWVGameCountryExample example) {
        BEGIN();
		...
		if (example != null && example.isDistinct()) {
			SELECT_DISTINCT(example.getSelectCols());
				...
				FROM("cwv_game_country");				applyWhere(example, false);
		}
        if(example != null){
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CWVGameCountry record = (CWVGameCountry) parameter.get("record");
        CWVGameCountryExample example = (CWVGameCountryExample) parameter.get("example");
        ...
        if (record.getCountryNameZh() != null) {
            SET("country_name_zh = #{record.countryNameZh,jdbcType=VARCHAR}");
        }
     ...
     * @mbggenerated Sat Jul 14 19:26:37 CST 2018
     */
    public String updateByPrimaryKeySelective(CWVGameCountry record) {
        BEGIN();
        UPDATE("cwv_game_country");
     ...
     * @mbggenerated Sat Jul 14 19:26:37 CST 2018
     */
    protected void applyWhere(CWVGameCountryExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
