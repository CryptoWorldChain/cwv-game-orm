...
import org.brewchain.cwv.dbgens.game.entity.CWVGamePropertyGameCopyCopyExample.Criterion;
import org.brewchain.cwv.dbgens.game.entity.CWVGamePropertyGameCopyCopyExample;

public class CWVGamePropertyGameCopyCopySqlProvider {
     ...
     */
    public String countByExample(CWVGamePropertyGameCopyCopyExample example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Fri Aug 03 16:45:08 CST 2018
     */
    public String deleteByExample(CWVGamePropertyGameCopyCopyExample example) {
        BEGIN();
        DELETE_FROM("cwv_game_property_game_copy_copy");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Fri Aug 03 16:45:08 CST 2018
     */
    public String insertSelective(CWVGamePropertyGameCopyCopy record) {
        BEGIN();
        INSERT_INTO("cwv_game_property_game_copy_copy");
     ...
     * @mbggenerated Fri Aug 03 16:45:08 CST 2018
     */
    public String selectByExample(CWVGamePropertyGameCopyCopyExample example) {
        BEGIN();
		...
		if (example != null && example.isDistinct()) {
			SELECT_DISTINCT(example.getSelectCols());
				...
				FROM("cwv_game_property_game_copy_copy");				applyWhere(example, false);
		}
        if(example != null){
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CWVGamePropertyGameCopyCopy record = (CWVGamePropertyGameCopyCopy) parameter.get("record");
        CWVGamePropertyGameCopyCopyExample example = (CWVGamePropertyGameCopyCopyExample) parameter.get("example");
     ...
     * @mbggenerated Fri Aug 03 16:45:08 CST 2018
     */
    public String updateByPrimaryKeySelective(CWVGamePropertyGameCopyCopy record) {
        BEGIN();
        UPDATE("cwv_game_property_game_copy_copy");
     ...
     * @mbggenerated Fri Aug 03 16:45:08 CST 2018
     */
    protected void applyWhere(CWVGamePropertyGameCopyCopyExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
