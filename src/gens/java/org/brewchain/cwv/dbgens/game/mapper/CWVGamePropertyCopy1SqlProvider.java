...
import org.brewchain.cwv.dbgens.game.entity.CWVGamePropertyCopy1Example.Criterion;
import org.brewchain.cwv.dbgens.game.entity.CWVGamePropertyCopy1Example;

public class CWVGamePropertyCopy1SqlProvider {
     ...
     */
    public String countByExample(CWVGamePropertyCopy1Example example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Fri Aug 03 16:45:08 CST 2018
     */
    public String deleteByExample(CWVGamePropertyCopy1Example example) {
        BEGIN();
        DELETE_FROM("cwv_game_property_copy1");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Fri Aug 03 16:45:08 CST 2018
     */
    public String insertSelective(CWVGamePropertyCopy1 record) {
        BEGIN();
        INSERT_INTO("cwv_game_property_copy1");
     ...
     * @mbggenerated Fri Aug 03 16:45:08 CST 2018
     */
    public String selectByExample(CWVGamePropertyCopy1Example example) {
        BEGIN();
		...
		if (example != null && example.isDistinct()) {
			SELECT_DISTINCT(example.getSelectCols());
				...
				FROM("cwv_game_property_copy1");				applyWhere(example, false);
		}
        if(example != null){
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CWVGamePropertyCopy1 record = (CWVGamePropertyCopy1) parameter.get("record");
        CWVGamePropertyCopy1Example example = (CWVGamePropertyCopy1Example) parameter.get("example");
     ...
     * @mbggenerated Fri Aug 03 16:45:08 CST 2018
     */
    public String updateByPrimaryKeySelective(CWVGamePropertyCopy1 record) {
        BEGIN();
        UPDATE("cwv_game_property_copy1");
     ...
     * @mbggenerated Fri Aug 03 16:45:08 CST 2018
     */
    protected void applyWhere(CWVGamePropertyCopy1Example example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
