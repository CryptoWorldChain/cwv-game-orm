...
import org.brewchain.cwv.dbgens.game.entity.CWVGamePropertyCopyExample.Criteria;
import org.brewchain.cwv.dbgens.game.entity.CWVGamePropertyCopyKey;
import org.brewchain.cwv.dbgens.game.mapper.CWVGamePropertyCopyMapper;
...
public class CWVGamePropertyCopyDao extends ExtendDaoSupper<CWVGamePropertyCopy, CWVGamePropertyCopyExample, CWVGamePropertyCopyKey>{
	...
	@Override
	public int countByExample(CWVGamePropertyCopyExample example) {
		return mapper.countByExample(example);
	}

	@Override
	public int deleteByExample(CWVGamePropertyCopyExample example)  throws Exception{
		return mapper.deleteByExample(example);
	}

	@Override
	public int deleteByPrimaryKey(CWVGamePropertyCopyKey key)  throws Exception{
		return mapper.deleteByPrimaryKey(key);
	}

	@Override
	public int insert(CWVGamePropertyCopy record)   throws Exception{
		return mapper.insert(record);
	}

	@Override
	public int insertSelective(CWVGamePropertyCopy record)   throws Exception{
		return mapper.insertSelective(record);
	}

	@Override
	//@Transactional
	public int batchUpdate(List<CWVGamePropertyCopy> records) throws Exception
			 {
		for(CWVGamePropertyCopy record : records){
	...
	@Override
	//@Transactional
	public int batchDelete(List<CWVGamePropertyCopy> records) throws Exception
			 {
		for(CWVGamePropertyCopy record : records){
	...
	@Override
	public List<CWVGamePropertyCopy> selectByExample(CWVGamePropertyCopyExample example)
			 {
		return mapper.selectByExample(example);
	}

	@Override
	public CWVGamePropertyCopy selectByPrimaryKey(CWVGamePropertyCopyKey key)
			 {
		return mapper.selectByPrimaryKey(key);
	}

	@Override
	public List<CWVGamePropertyCopy> findAll(List<CWVGamePropertyCopy> records) {
		if(records==null||records.size()<=0){
			return mapper.selectByExample(new CWVGamePropertyCopyExample());
		}
		List<CWVGamePropertyCopy> list = new ArrayList<>();
		for(CWVGamePropertyCopy record : records){
			CWVGamePropertyCopy result = mapper.selectByPrimaryKey(record);
			if(result!=null){
				list.add(result);
			}
		}
	...
	@Override
	public int updateByExampleSelective(CWVGamePropertyCopy record, CWVGamePropertyCopyExample example)  throws Exception {
		return mapper.updateByExampleSelective(record, example);
	}

	@Override
	public int updateByExample(CWVGamePropertyCopy record, CWVGamePropertyCopyExample example)  throws Exception{
		return mapper.updateByExample(record, example);
	}

	@Override
	public int updateByPrimaryKeySelective(CWVGamePropertyCopy record)  throws Exception{
		return mapper.updateByPrimaryKeySelective(record);
	}

	@Override
	public int updateByPrimaryKey(CWVGamePropertyCopy record)  throws Exception{
		return mapper.updateByPrimaryKey(record);
	}

	@Override
	public int sumByExample(CWVGamePropertyCopyExample example) {
		return 0;
	}

	@Override
	public void deleteAll()  throws Exception {
		mapper.deleteByExample(new CWVGamePropertyCopyExample());
	}

	@Override
	public CWVGamePropertyCopyExample getExample(CWVGamePropertyCopy record) {
		CWVGamePropertyCopyExample example = new CWVGamePropertyCopyExample();
		if(record!=null){
	...
	public CWVGamePropertyCopy selectOneByExample(CWVGamePropertyCopyExample example)
			 {
		example.setLimit(1);
		List<CWVGamePropertyCopy> list=mapper.selectByExample(example);
	...
	@Override
	//@Transactional
	public int batchInsert(List<CWVGamePropertyCopy> records) throws Exception {
