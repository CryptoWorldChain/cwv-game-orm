...
import org.brewchain.cwv.dbgens.game.entity.CWVGameTxHandleExample.Criterion;
import org.brewchain.cwv.dbgens.game.entity.CWVGameTxHandleExample;

public class CWVGameTxHandleSqlProvider {
     ...
     */
    public String countByExample(CWVGameTxHandleExample example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Fri Jul 20 14:49:37 CST 2018
     */
    public String deleteByExample(CWVGameTxHandleExample example) {
        BEGIN();
        DELETE_FROM("cwv_game_tx_handle");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Fri Jul 20 14:49:37 CST 2018
     */
    public String insertSelective(CWVGameTxHandle record) {
        BEGIN();
        INSERT_INTO("cwv_game_tx_handle");
     ...
     * @mbggenerated Fri Jul 20 14:49:37 CST 2018
     */
    public String selectByExample(CWVGameTxHandleExample example) {
        BEGIN();
		...
		if (example != null && example.isDistinct()) {
			SELECT_DISTINCT(example.getSelectCols());
				...
				FROM("cwv_game_tx_handle");				applyWhere(example, false);
		}
        if(example != null){
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CWVGameTxHandle record = (CWVGameTxHandle) parameter.get("record");
        CWVGameTxHandleExample example = (CWVGameTxHandleExample) parameter.get("example");
     ...
     * @mbggenerated Fri Jul 20 14:49:37 CST 2018
     */
    public String updateByPrimaryKeySelective(CWVGameTxHandle record) {
        BEGIN();
        UPDATE("cwv_game_tx_handle");
     ...
     * @mbggenerated Fri Jul 20 14:49:37 CST 2018
     */
    protected void applyWhere(CWVGameTxHandleExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
