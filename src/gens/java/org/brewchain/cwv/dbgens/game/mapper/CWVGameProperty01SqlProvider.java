...
import org.brewchain.cwv.dbgens.game.entity.CWVGameProperty01Example.Criterion;
import org.brewchain.cwv.dbgens.game.entity.CWVGameProperty01Example;

public class CWVGameProperty01SqlProvider {
     ...
     */
    public String countByExample(CWVGameProperty01Example example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Mon Jun 04 22:59:11 CST 2018
     */
    public String deleteByExample(CWVGameProperty01Example example) {
        BEGIN();
        DELETE_FROM("cwv_game_property_01");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Mon Jun 04 22:59:11 CST 2018
     */
    public String insertSelective(CWVGameProperty01 record) {
        BEGIN();
        INSERT_INTO("cwv_game_property_01");
     ...
     * @mbggenerated Mon Jun 04 22:59:11 CST 2018
     */
    public String selectByExample(CWVGameProperty01Example example) {
        BEGIN();
		...
		if (example != null && example.isDistinct()) {
			SELECT_DISTINCT(example.getSelectCols());
				...
				FROM("cwv_game_property_01");				applyWhere(example, false);
		}
        if(example != null){
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CWVGameProperty01 record = (CWVGameProperty01) parameter.get("record");
        CWVGameProperty01Example example = (CWVGameProperty01Example) parameter.get("example");
     ...
     * @mbggenerated Mon Jun 04 22:59:11 CST 2018
     */
    public String updateByPrimaryKeySelective(CWVGameProperty01 record) {
        BEGIN();
        UPDATE("cwv_game_property_01");
     ...
     * @mbggenerated Mon Jun 04 22:59:11 CST 2018
     */
    protected void applyWhere(CWVGameProperty01Example example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
