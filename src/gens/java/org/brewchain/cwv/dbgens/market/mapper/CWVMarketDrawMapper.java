...
public interface CWVMarketDrawMapper extends StaticTableDaoSupport<CWVMarketDraw, CWVMarketDrawExample, CWVMarketDrawKey> {
    ...
    @Insert({
        ...
        "#{chainContract,jdbcType=VARCHAR}, #{userAddress,jdbcType=VARCHAR}, ",
        "#{propertyToken,jdbcType=VARCHAR})"
    })
    ...
    @Select({
        ...
        "chain_contract, user_address, property_token",
