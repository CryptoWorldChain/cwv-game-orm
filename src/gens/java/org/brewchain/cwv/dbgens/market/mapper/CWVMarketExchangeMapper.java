...
public interface CWVMarketExchangeMapper extends StaticTableDaoSupport<CWVMarketExchange, CWVMarketExchangeExample, CWVMarketExchangeKey> {
    ...
    @Insert({
        ...
        "#{countryId,jdbcType=INTEGER}, #{cityId,jdbcType=INTEGER}, ",
    ...
    @Select({
        ...
        "create_user, country_id, city_id, map_id, property_template_id, property_template, ",
        "nick_name, property_name, property_type, property_status, income_remark, income, ",
