...
import org.brewchain.cwv.dbgens.market.entity.CWVMarketExceptionExample.Criterion;
import org.brewchain.cwv.dbgens.market.entity.CWVMarketExceptionExample;

public class CWVMarketExceptionSqlProvider {
     ...
     */
    public String countByExample(CWVMarketExceptionExample example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Wed Aug 22 14:07:29 CST 2018
     */
    public String deleteByExample(CWVMarketExceptionExample example) {
        BEGIN();
        DELETE_FROM("cwv_market_exception");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Wed Aug 22 14:07:29 CST 2018
     */
    public String insertSelective(CWVMarketException record) {
        BEGIN();
        INSERT_INTO("cwv_market_exception");
        ...
        if (record.getLogMethod() != null) {
            VALUES("log_method", "#{logMethod,jdbcType=VARCHAR}");
        }
     ...
     * @mbggenerated Wed Aug 22 14:07:29 CST 2018
     */
    public String selectByExample(CWVMarketExceptionExample example) {
        BEGIN();
		...
		if (example != null && example.isDistinct()) {
			SELECT_DISTINCT(example.getSelectCols());
				...
				FROM("cwv_market_exception");				applyWhere(example, false);
		}
        if(example != null){
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CWVMarketException record = (CWVMarketException) parameter.get("record");
        CWVMarketExceptionExample example = (CWVMarketExceptionExample) parameter.get("example");
        ...
        if (record.getLogMethod() != null) {
            SET("log_method = #{record.logMethod,jdbcType=VARCHAR}");
        }
     ...
     * @mbggenerated Wed Aug 22 14:07:29 CST 2018
     */
    public String updateByPrimaryKeySelective(CWVMarketException record) {
        BEGIN();
        UPDATE("cwv_market_exception");
     ...
     * @mbggenerated Wed Aug 22 14:07:29 CST 2018
     */
    protected void applyWhere(CWVMarketExceptionExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
