...
public interface CWVMarketBidMapper extends StaticTableDaoSupport<CWVMarketBid, CWVMarketBidExample, CWVMarketBidKey> {
    ...
    @Insert({
        ...
        "nick_name, property_name, ",
        "property_type, property_status, ",
        "income_remark, last_price, ",
        "image_url)",
        ...
        "#{countryId,jdbcType=INTEGER}, #{mapId,jdbcType=INTEGER}, ",
        "#{propertyTemplateId,jdbcType=VARCHAR}, #{propertyTemplate,jdbcType=VARCHAR}, ",
        "#{nickName,jdbcType=VARCHAR}, #{propertyName,jdbcType=VARCHAR}, ",
        "#{propertyType,jdbcType=VARCHAR}, #{propertyStatus,jdbcType=VARCHAR}, ",
        "#{incomeRemark,jdbcType=VARCHAR}, #{lastPrice,jdbcType=DECIMAL}, ",
    ...
    @Select({
        ...
        "create_time, create_user, country_id, map_id, property_template_id, property_template, ",
        "nick_name, property_name, property_type, property_status, income_remark, last_price, ",
        "image_url",
        "from cwv_market_bid",
        "where bid_id = #{bidId,jdbcType=INTEGER}"
    })
