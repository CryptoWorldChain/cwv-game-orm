...
public interface CWVMarketBidMapper extends StaticTableDaoSupport<CWVMarketBid, CWVMarketBidExample, CWVMarketBidKey> {
    ...
    @Insert({
        ...
        "chain_trans_hash_end, chain_max_amount, ",
        ...
        "#{chainTransHashEnd,jdbcType=VARCHAR}, #{chainMaxAmount,jdbcType=DECIMAL}, ",
    ...
    @Select({
        ...
        "chain_contract, chain_status_end, chain_trans_hash_end, chain_max_amount, chain_max_address, ",
        "last_update_time, announce_time, create_time, create_user, country_id, map_id, ",
        "property_template_id, property_template, nick_name, property_name, property_type, ",
