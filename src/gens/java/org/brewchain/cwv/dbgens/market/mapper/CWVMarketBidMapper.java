...
public interface CWVMarketBidMapper extends StaticTableDaoSupport<CWVMarketBid, CWVMarketBidExample, CWVMarketBidKey> {
    ...
    @Insert({
        ...
        "increase_ladder, bid_start, ",
        "bid_amount, bidders_count, ",
        "status, last_update_time, ",
        "announce_time, create_time, ",
        "create_user)",
        "values (#{bidId,jdbcType=INTEGER}, #{gamePropertyId,jdbcType=INTEGER}, ",
        "#{auctionStart,jdbcType=TIMESTAMP}, #{auctionEnd,jdbcType=TIMESTAMP}, ",
        "#{increaseLadder,jdbcType=DECIMAL}, #{bidStart,jdbcType=DECIMAL}, ",
        "#{bidAmount,jdbcType=DECIMAL}, #{biddersCount,jdbcType=INTEGER}, ",
    ...
    @Select({
        "select",
        "bid_id, game_property_id, auction_start, auction_end, increase_ladder, bid_start, ",
        "bid_amount, bidders_count, status, last_update_time, announce_time, create_time, ",
        "create_user",
        "from cwv_market_bid",
        "where bid_id = #{bidId,jdbcType=INTEGER}"
    })
