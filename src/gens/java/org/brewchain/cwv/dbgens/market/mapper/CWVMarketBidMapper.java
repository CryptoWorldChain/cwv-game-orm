...
public interface CWVMarketBidMapper extends StaticTableDaoSupport<CWVMarketBid, CWVMarketBidExample, CWVMarketBidKey> {
    ...
    @Insert({
        ...
        "chain_contract, chain_status_end, ",
        "chain_trans_hash_end, chain_status_max_amount, ",
        "chain_trans_hash_max_amount, chain_max_amount, ",
        "chain_status_max_address, chain_trans_hash_max_address, ",
        "chain_max_address, last_update_time, ",
        ...
        "#{chainContract,jdbcType=VARCHAR}, #{chainStatusEnd,jdbcType=TINYINT}, ",
        "#{chainTransHashEnd,jdbcType=VARCHAR}, #{chainStatusMaxAmount,jdbcType=TINYINT}, ",
        "#{chainTransHashMaxAmount,jdbcType=VARCHAR}, #{chainMaxAmount,jdbcType=DECIMAL}, ",
        "#{chainStatusMaxAddress,jdbcType=TINYINT}, #{chainTransHashMaxAddress,jdbcType=VARCHAR}, ",
        "#{chainMaxAddress,jdbcType=VARCHAR}, #{lastUpdateTime,jdbcType=TIMESTAMP}, ",
    ...
    @Results({
        ...
        @Result(column="chain_status_end", property="chainStatusEnd", jdbcType=JdbcType.TINYINT),
        @Result(column="chain_trans_hash_end", property="chainTransHashEnd", jdbcType=JdbcType.VARCHAR),
        @Result(column="chain_status_max_amount", property="chainStatusMaxAmount", jdbcType=JdbcType.TINYINT),
        @Result(column="chain_trans_hash_max_amount", property="chainTransHashMaxAmount", jdbcType=JdbcType.VARCHAR),
        @Result(column="chain_max_amount", property="chainMaxAmount", jdbcType=JdbcType.DECIMAL),
        @Result(column="chain_status_max_address", property="chainStatusMaxAddress", jdbcType=JdbcType.TINYINT),
        @Result(column="chain_trans_hash_max_address", property="chainTransHashMaxAddress", jdbcType=JdbcType.VARCHAR),
        @Result(column="chain_max_address", property="chainMaxAddress", jdbcType=JdbcType.VARCHAR),
    ...
    @Select({
        ...
        "chain_contract, chain_status_end, chain_trans_hash_end, chain_status_max_amount, ",
        "chain_trans_hash_max_amount, chain_max_amount, chain_status_max_address, chain_trans_hash_max_address, ",
        "chain_max_address, last_update_time, announce_time, create_time, create_user, ",
        "country_id, map_id, property_template_id, property_template, nick_name, property_name, ",
        "property_type, property_status, income_remark, last_price, image_url",
        "from cwv_market_bid",
        "where bid_id = #{bidId,jdbcType=INTEGER}"
    })
    @Results({
    ...
    @Update({
        ...
        "set game_property_id = #{gamePropertyId,jdbcType=INTEGER},",
          ...
          "chain_status_end = #{chainStatusEnd,jdbcType=TINYINT},",
          "chain_trans_hash_end = #{chainTransHashEnd,jdbcType=VARCHAR},",
          "chain_status_max_amount = #{chainStatusMaxAmount,jdbcType=TINYINT},",
          "chain_trans_hash_max_amount = #{chainTransHashMaxAmount,jdbcType=VARCHAR},",
          "chain_max_amount = #{chainMaxAmount,jdbcType=DECIMAL},",
          "chain_status_max_address = #{chainStatusMaxAddress,jdbcType=TINYINT},",
          "chain_trans_hash_max_address = #{chainTransHashMaxAddress,jdbcType=VARCHAR},",
          "chain_max_address = #{chainMaxAddress,jdbcType=VARCHAR},",
