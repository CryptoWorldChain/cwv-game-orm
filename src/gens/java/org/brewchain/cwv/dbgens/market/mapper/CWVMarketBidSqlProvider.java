...
public class CWVMarketBidSqlProvider {
    ...
    public String insertSelective(CWVMarketBid record) {
        ...
        if (record.getChainStatusEnd() != null) {
            VALUES("chain_status_end", "#{chainStatusEnd,jdbcType=TINYINT}");
        }
        
        if (record.getChainTransHashEnd() != null) {
            VALUES("chain_trans_hash_end", "#{chainTransHashEnd,jdbcType=VARCHAR}");
        }
        
        if (record.getChainStatusMaxAmount() != null) {
            VALUES("chain_status_max_amount", "#{chainStatusMaxAmount,jdbcType=TINYINT}");
        }
        
        if (record.getChainTransHashMaxAmount() != null) {
            VALUES("chain_trans_hash_max_amount", "#{chainTransHashMaxAmount,jdbcType=VARCHAR}");
        }
        
        if (record.getChainMaxAmount() != null) {
            VALUES("chain_max_amount", "#{chainMaxAmount,jdbcType=DECIMAL}");
        }
        
        if (record.getChainStatusMaxAddress() != null) {
            VALUES("chain_status_max_address", "#{chainStatusMaxAddress,jdbcType=TINYINT}");
        }
        
        if (record.getChainTransHashMaxAddress() != null) {
            VALUES("chain_trans_hash_max_address", "#{chainTransHashMaxAddress,jdbcType=VARCHAR}");
        }
        
        if (record.getChainMaxAddress() != null) {
            VALUES("chain_max_address", "#{chainMaxAddress,jdbcType=VARCHAR}");
        }
    ...
    public String selectByExample(CWVMarketBidExample example) {
        ...
        SELECT("chain_status_end");
        SELECT("chain_trans_hash_end");
        SELECT("chain_status_max_amount");
        SELECT("chain_trans_hash_max_amount");
        SELECT("chain_max_amount");
        SELECT("chain_status_max_address");
        SELECT("chain_trans_hash_max_address");
        SELECT("chain_max_address");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getChainStatusEnd() != null) {
            SET("chain_status_end = #{record.chainStatusEnd,jdbcType=TINYINT}");
        }
        
        if (record.getChainTransHashEnd() != null) {
            SET("chain_trans_hash_end = #{record.chainTransHashEnd,jdbcType=VARCHAR}");
        }
        
        if (record.getChainStatusMaxAmount() != null) {
            SET("chain_status_max_amount = #{record.chainStatusMaxAmount,jdbcType=TINYINT}");
        }
        
        if (record.getChainTransHashMaxAmount() != null) {
            SET("chain_trans_hash_max_amount = #{record.chainTransHashMaxAmount,jdbcType=VARCHAR}");
        }
        
        if (record.getChainMaxAmount() != null) {
            SET("chain_max_amount = #{record.chainMaxAmount,jdbcType=DECIMAL}");
        }
        
        if (record.getChainStatusMaxAddress() != null) {
            SET("chain_status_max_address = #{record.chainStatusMaxAddress,jdbcType=TINYINT}");
        }
        
        if (record.getChainTransHashMaxAddress() != null) {
            SET("chain_trans_hash_max_address = #{record.chainTransHashMaxAddress,jdbcType=VARCHAR}");
        }
        
        if (record.getChainMaxAddress() != null) {
            SET("chain_max_address = #{record.chainMaxAddress,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(CWVMarketBid record) {
        ...
        if (record.getChainStatusEnd() != null) {
            SET("chain_status_end = #{chainStatusEnd,jdbcType=TINYINT}");
        }
        
        if (record.getChainTransHashEnd() != null) {
            SET("chain_trans_hash_end = #{chainTransHashEnd,jdbcType=VARCHAR}");
        }
        
        if (record.getChainStatusMaxAmount() != null) {
            SET("chain_status_max_amount = #{chainStatusMaxAmount,jdbcType=TINYINT}");
        }
        
        if (record.getChainTransHashMaxAmount() != null) {
            SET("chain_trans_hash_max_amount = #{chainTransHashMaxAmount,jdbcType=VARCHAR}");
        }
        
        if (record.getChainMaxAmount() != null) {
            SET("chain_max_amount = #{chainMaxAmount,jdbcType=DECIMAL}");
        }
        
        if (record.getChainStatusMaxAddress() != null) {
            SET("chain_status_max_address = #{chainStatusMaxAddress,jdbcType=TINYINT}");
        }
        
        if (record.getChainTransHashMaxAddress() != null) {
            SET("chain_trans_hash_max_address = #{chainTransHashMaxAddress,jdbcType=VARCHAR}");
        }
        
        if (record.getChainMaxAddress() != null) {
            SET("chain_max_address = #{chainMaxAddress,jdbcType=VARCHAR}");
        }
