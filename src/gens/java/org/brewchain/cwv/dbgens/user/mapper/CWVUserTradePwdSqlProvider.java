...
import org.brewchain.cwv.dbgens.user.entity.CWVUserTradePwdExample.Criterion;
import org.brewchain.cwv.dbgens.user.entity.CWVUserTradePwdExample;

public class CWVUserTradePwdSqlProvider {
     ...
     */
    public String countByExample(CWVUserTradePwdExample example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Wed May 23 22:06:41 CST 2018
     */
    public String deleteByExample(CWVUserTradePwdExample example) {
        BEGIN();
        DELETE_FROM("cwv_user_trade_pwd");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Wed May 23 22:06:41 CST 2018
     */
    public String insertSelective(CWVUserTradePwd record) {
        BEGIN();
        INSERT_INTO("cwv_user_trade_pwd");
     ...
     * @mbggenerated Wed May 23 22:06:41 CST 2018
     */
    public String selectByExample(CWVUserTradePwdExample example) {
        BEGIN();
		...
		if (example != null && example.isDistinct()) {
			SELECT_DISTINCT(example.getSelectCols());
				...
				FROM("cwv_user_trade_pwd");				applyWhere(example, false);
		}
        if(example != null){
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CWVUserTradePwd record = (CWVUserTradePwd) parameter.get("record");
        CWVUserTradePwdExample example = (CWVUserTradePwdExample) parameter.get("example");
     ...
     * @mbggenerated Wed May 23 22:06:41 CST 2018
     */
    public String updateByPrimaryKeySelective(CWVUserTradePwd record) {
        BEGIN();
        UPDATE("cwv_user_trade_pwd");
     ...
     * @mbggenerated Wed May 23 22:06:41 CST 2018
     */
    protected void applyWhere(CWVUserTradePwdExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
