...
public interface CWVUserPropertyIncomeMapper extends StaticTableDaoSupport<CWVUserPropertyIncome, CWVUserPropertyIncomeExample, CWVUserPropertyIncomeKey> {
    ...
    @Insert({
        ...
        "chain_status_claim, chain_trans_hash_claim, ",
        "amount, master, ",
        "status, start_time, ",
        "end_time)",
        ...
        "#{chainStatusClaim,jdbcType=TINYINT}, #{chainTransHashClaim,jdbcType=VARCHAR}, ",
        "#{amount,jdbcType=DECIMAL}, #{master,jdbcType=INTEGER}, ",
        "#{status,jdbcType=TINYINT}, #{startTime,jdbcType=TIMESTAMP}, ",
    ...
    @Results({
        ...
        @Result(column="chain_status_claim", property="chainStatusClaim", jdbcType=JdbcType.TINYINT),
        @Result(column="chain_trans_hash_claim", property="chainTransHashClaim", jdbcType=JdbcType.VARCHAR),
        @Result(column="amount", property="amount", jdbcType=JdbcType.DECIMAL),
        @Result(column="master", property="master", jdbcType=JdbcType.INTEGER),
    ...
    @Select({
        "select",
        "income_id, user_id, type, property_id, chain_status, chain_trans_hash, chain_status_claim, ",
        "chain_trans_hash_claim, amount, master, status, start_time, end_time",
    ...
    @Update({
        ...
        "set user_id = #{userId,jdbcType=INTEGER},",
          ...
          "chain_status_claim = #{chainStatusClaim,jdbcType=TINYINT},",
          "chain_trans_hash_claim = #{chainTransHashClaim,jdbcType=VARCHAR},",
