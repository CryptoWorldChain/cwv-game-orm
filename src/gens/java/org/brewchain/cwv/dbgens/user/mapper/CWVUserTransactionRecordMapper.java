...
public interface CWVUserTransactionRecordMapper extends StaticTableDaoSupport<CWVUserTransactionRecord, CWVUserTransactionRecordExample, CWVUserTransactionRecordKey> {
    ...
    @Insert({
        ...
        "trade_id, detail, ",
        "gain_cost, create_time, ",
        "create_user)",
        "values (#{recordId,jdbcType=INTEGER}, #{userId,jdbcType=INTEGER}, ",
        "#{tradeId,jdbcType=INTEGER}, #{detail,jdbcType=VARCHAR}, ",
        "#{gainCost,jdbcType=DECIMAL}, #{createTime,jdbcType=TIMESTAMP}, ",
    ...
    @Select({
        "select",
        "record_id, user_id, trade_id, detail, gain_cost, create_time, create_user",
