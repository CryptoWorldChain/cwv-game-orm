...
public interface CWVUserWalletMapper extends StaticTableDaoSupport<CWVUserWallet, CWVUserWalletExample, CWVUserWalletKey> {
    ...
    @Insert({
        ...
        "#{drawCount,jdbcType=INTEGER}, #{incomeOrdinary,jdbcType=DECIMAL}, ",
    ...
    @Select({
        ...
        "income_ordinary, income_typical, income_functional, update_time, create_time, ",
        "coin_icon",
